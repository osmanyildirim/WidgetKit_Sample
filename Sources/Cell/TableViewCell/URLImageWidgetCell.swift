...
final class URLImageWidgetCell: UITableViewCell, BaseTableViewCell {
...
extension URLImageWidgetCell {
    func configure() {
        titleLabel.text = "URLImage Widget"
        urlLabel.text = "lorempokemon.fakerapi.it/pokemon"
        descriptionLabel.text = """
                                   Widget request this API and displays random Pokemon image.
