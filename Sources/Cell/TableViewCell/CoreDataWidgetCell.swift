...
final class CoreDataWidgetCell: UITableViewCell, BaseTableViewCell {
...
extension CoreDataWidgetCell {
    func configure(_ data: [Pokemon], selectedIndex: IndexPath?) {
        self.data = data
        self.selectedIndex = selectedIndex

        titleLabel.text = "Core Data Widget"
        ...
        selectionLabel.attributedText = data[selectedIndex.row].speciesText.htmlToAttributedString
...
extension CoreDataWidgetCell: UICollectionViewDataSource, UICollectionViewDelegate {
