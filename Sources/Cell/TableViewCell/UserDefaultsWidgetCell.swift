...
final class UserDefaultsWidgetCell: UITableViewCell, BaseTableViewCell {
...
extension UserDefaultsWidgetCell {
    func configure(_ data: [Pokemon], selectedIndex: IndexPath?) {
        self.data = data
        self.selectedIndex = selectedIndex

        titleLabel.text = "UserDefaults Widget"
        ...
        selectionLabel.attributedText = data[selectedIndex.row].typeText.htmlToAttributedString
...
extension UserDefaultsWidgetCell: UICollectionViewDataSource, UICollectionViewDelegate {
